...
$strJsonFileContents = file_get_contents("../themes/mirage/template_defs/home.json");
...
<body>
    <div id="app">
        <input type="text" v-model="templateName" placeholder="Template Name">
        <input type="text" v-model="title" placeholder="Page Title">
        <input type="text" v-model="path" placeholder="Page Path">
